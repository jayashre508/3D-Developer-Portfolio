...
export default function Island({  isRotating,
...
const handlePointerDown = (e) => {
  e.stopPropagation(); //this means the mouse click is only going to do what it does in this function and it wont touch any other function or elements in the screen
  e.preventDefault();
  setIsRotating(true);
